...
::: {.callout-note}
[ **Prior to European colonization the fee tracts within the Montana FWS fire zone had `r formatC(sum(all_annual_fire$acres), format = "f", big.mark = ",", digits = 0)` acres of fire annually.** ]{style="font-size: 1.5em;"}
:::
