...
bps_data <- read.csv("data/mid_plains/bps_aoi_attributes.csv")
...
evt_data <- read_csv(file = "data/mid_plains/evt_aoi_attributes.csv")

evc_data <- read.csv("data/mid_plains/evc_aoi_attributes.csv") 

evh_data <- read.csv("data/mid_plains/evh_aoi_attributes.csv") 
...
::: {.callout-note}
[ **Prior to European colonization the fee tracts within the FWS Mid-Plains fire zone had `r formatC(sum(all_annual_fire$acres), format = "f", big.mark = ",", digits = 0)` acres of fire annually.** ]{style="font-size: 1.5em;"}
:::
...
additional_shape <- st_read("data/mid_plains/mid_plains_tracts.shp", quiet = TRUE)
