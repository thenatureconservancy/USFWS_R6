...
bps_data <- read.csv("data/north_dakota/bps_aoi_attributes.csv")
...
evt_data <- read_csv(file = "data/north_dakota/evt_aoi_attributes.csv")

evc_data <- read.csv("data/north_dakota/evc_aoi_attributes.csv") 

evh_data <- read.csv("data/north_dakota/evh_aoi_attributes.csv") 
...
::: {.callout-note}
[ **Prior to European colonization the fee tracts within the FWS North Dakota fire zone had `r formatC(sum(all_annual_fire$acres), format = "f", big.mark = ",", digits = 0)` acres of fire annually.** ]{style="font-size: 1.5em;"}
:::
...
additional_shape <- st_read("data/north_dakota/north_dakota_tracks.shp", quiet = TRUE)
